...
String[] phrases = {
"Qué te dice Facebook?",
"ME GUSTA",
"XD LOL"
};

ArrayList<PImage> meme = new ArrayList<PImage>();
...
void typewriteText(String txt, int x, int y){

  if (counter < txt.length()) {
     counter++;
     textSize(90);
     fill(255,0,0);
    text(txt.substring(0, counter), x, y, width,height);
  } else {
  counter = 0;
}
}
